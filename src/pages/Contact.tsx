      ...
      <div className="container py-8 md:py-16">
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <aside className="hidden lg:block" aria-hidden>
            <div className="rounded-xl p-4 border border-divider bg-surface-elevated text-sm text-muted-foreground text-center">
              We&apos;re here to help with any questions about StudyFlow.
            </div>
          </aside>
        </div>
      </div>
